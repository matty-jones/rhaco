...
@pytest.fixture(
    ...
    params=[
        ...
        {"--template": "corundum.pdb", "--dimensions": "15x15x1", "--z_reactor_size": "15.0", "--crystal_separation": "15.0", "--reactant_composition": "{'Ag_5nm': 'pos', 'C2H6': 1}", "--reactant_position": "[[0.0, 0.0, 4.5]]", "--reactant_density": "0.05", "--forcefield": "['Ag_Zhou04.eam.alloy', 'FF_opls_elliott.xml']", "--crystal_x": "0.4759", "--crystal_y": "0.4759", "--crystal_z": "1.299"},
    ],
    # ids=[
